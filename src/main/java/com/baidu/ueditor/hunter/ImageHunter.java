...
public class ImageHunter {
	...
	public State captureRemoteData ( String urlStr ) {
		...
		try {
			...
			try {
				ALiYunUtil.uploadFile(ALiYunUtil.BUCKET_NAME, key, is, connection.getContentLength());
				state = new BaseState(true);
				state.putInfo( "size", connection.getContentLength());
				state.putInfo( "title", this.filename );
			...
			if ( state.isSuccess() ) {
				state.putInfo( "url", ALiYunUtil.IMAGE_URL+key );
				state.putInfo( "source", urlStr );
			}
